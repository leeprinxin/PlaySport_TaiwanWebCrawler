...
class SerieAWebCrawler(object):
    def __init__(self):
        ...
        self.SerieA_UpcomingMacths_URLs = [f"https://www.playsport.cc/predictgame.php?allianceid={4}&gametime={day}" for day in days]
        ...
        self.SportCode = 1  # SerieA運動編碼: 1 來自SportCode table
        self.SportTournamentCode = '10041110'  # 沿用
        self.EventType = 0
    ...
    def get_MatchResultsBySelenium(self, day = '1天'):
        """
        從https://www.sportslottery.com.tw/zh-tw/game/pre取得SerieA今日結束比賽
        :param
        :return:
        """
        ...
        sleep(1)
        browser.find_element_by_xpath("//option[contains(text(),'義大利')]").click()
        sleep(1)
        browser.find_element_by_xpath("//option[contains(text(),'義大利甲級聯賽')]").click()
        sleep(1)
    ...
    def get_MatchEntry(self):
        """
        從https://www.playsport.cc/predictgame.php?allianceid=4&from=header取得SerieA所有比賽
        :param
        :return:
        """
        ...
        for url in self.SerieA_UpcomingMacths_URLs:
...
if __name__ == '__main__':
    ...
    SerieAWebCrawler.start(MatchResultsSearchDays='3週')