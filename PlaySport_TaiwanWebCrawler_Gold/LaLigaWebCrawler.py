...
from LaLiga import LaLigaWebCrawler
...
def send_JandiErrorsMessage(except_texts):
    ...
    text += f'Python File (TaiwanWebCrawler): LaLigaWebCrawler發生錯誤即通報報此異常訊息。\n'
...
def RUN_WebCrawler():
    ...
    laligawebcrawler.start(MatchResultsSearchDays='3天') #天數 or 週 or 月份 EX. 1天, 3天, 1週, 3週, 1月, 2月, 3月 (type:str)
